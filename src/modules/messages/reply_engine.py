...
DEFAULT_INTENT_RULES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "reply": "兑换码是您拍下付款后系统自动发到消息里的一串字符，在小程序「我的-兑换优惠」里粘贴兑换成下单余额，再填地址选快递即可~",
        "priority": 43,
        "categories": ["express"],
        "phase": "presale",
    },
    {
        "name": "express_pickup_faq",
        "keywords": [
            "上门取",
            "上门取件",
            "快递员来取",
        ...
        "reply": "可以上门取件的~ 您在小程序里下单后预约时段，快递员会按约定上门揽收，具体时间以小程序显示为准~",
        "priority": 43,
        "categories": ["express"],
        "phase": "presale",
    },
    {
        "name": "express_clarify_followup",
        "keywords": ["啥意思", "什么意思", "没懂", "不懂", "不明白", "没理解", "看不懂", "怎么说"],
        "reply": "刚才没说清楚抱歉~ 您发「寄件城市-收件城市-重量kg」我帮您查参考价；大件再补长宽高，我帮您核对体积重~",
        "priority": 43,
        "categories": ["express"],
        "phase": "presale",
    },
    ...
    },
    {
        ...
        "exclude_patterns": [r"寄电池", r"寄刀", r"寄手机", r"寄数码", r"香烟", r"寄烟"],
        "reply": "大部分物品都可以寄~ 告诉我具体物品、路线和重量，帮您查价确认~",
        "priority": 50,
        "categories": ["express"],
        "phase": "presale",
    },
    ...
    # ============================================================
    {
        ...
        "exclude_patterns": [
            r"\d+\s*(?:kg|公斤|斤|g|克|cm|厘米)",
            r"[\u4e00-\u9fa5]{2,4}\s*(?:到|寄|发)\s*[\u4e00-\u9fa5]{2,4}",
            r"不要了",
            r"算了",
            r"不用了",
            r"不需要",
