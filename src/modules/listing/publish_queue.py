...
TITLE_TEMPLATES: dict[str, list[str]] = {
    ...
    "freight": [
        "大件物流 家具电器全国寄 {brands} 上门取件 低至1元每公斤",
        "搬家寄大件 家具家电行李 {brands} 免费上门取件 全国可寄",
        "大件快运 30-200kg 家具电器健身器材 {brands} 上门取件",
        "家具运输 沙发床垫冰箱洗衣机 大件物流 {brands} 全国上门取件",
        "毕业寄行李 大件搬家 {brands} 物流上门取件 低至{price}元起",
        "大件快运 越重越便宜 {brands} 全国上门取件 30kg起",
        "电器寄送 冰箱洗衣机空调 大件物流 {brands} 免费上门取件",
        "行李托运 搬家寄件 大件物流 {brands} 全国可寄 上门取件",
        "大件物流代发 {brands} 家具家电搬家 全国免费上门取件",
        "{brands} 大件快运 跑步机椭圆机 健身器材运输 全国上门取件",
        "寄大件 便宜物流 {brands} 家具电器行李 全国可寄 上门取件",
        "大件搬家物流 {brands} 床垫衣柜桌椅 免费上门取件 全国可发",
        "大件快运代寄 {brands} 越重越划算 家具电器搬家行李托运",
        "物流寄大件 {brands} 30kg起步 家具家电健身器材 上门取件",
        "大件便宜寄 物流代发 {brands} 搬家行李家具电器 全国上门取件",
        "家电运输 大件物流 {brands} 冰箱空调洗衣机 全国免费上门取件",
    ],
}

PRICE_OPTIONS: dict[str, list[str]] = {
    "express": ["1", "1", "1", "1.5", "2", "3"],
    "freight": ["30", "35", "38", "40", "45"],
}
