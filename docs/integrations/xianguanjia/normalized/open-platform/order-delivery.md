...
## raw_html_path
`/Users/brianzhibo/openclaw/xianyu-openclaw/docs/external/xianguanjia/fullcrawl/raw/02ed8480b69042ee.html`
...
| waybill_no | string | 是 | 物流单号 |
| express_code | string | 是 | 快递公司编码 |
