...
## raw_html_path
`/Users/brianzhibo/openclaw/xianyu-openclaw/docs/external/xianguanjia/fullcrawl/raw/2b916cf65a469356.html`
...
| price | int | 是 | 调整后订单金额（分） |
| adjust_reason | string | 否 | 改价原因备注 |
