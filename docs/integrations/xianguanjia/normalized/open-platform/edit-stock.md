...
## raw_html_path
`/Users/brianzhibo/openclaw/xianyu-openclaw/docs/external/xianguanjia/fullcrawl/raw/8f711e492c36f84f.html`
...
| sku_id | int64 | 否 | 指定 SKU ID（单规格商品可不传） |
| price | int | 否 | SKU 售价（分） |
| stock | int | 是 | 库存数量 |
